class script(object):
    START_TXT = ""NAMASTE{},
MERA NAAM HAI <a href=https://t.me/{}>{}</a>, MAI AAPKO LAKAR DUNGA 𝙼𝙾𝚅𝙸𝙴𝚂 & WEB SERIES, BASS MUJHE ADD KIJIYE APNE 𝙶𝚁𝙾𝚄𝙿 MEIN & 𝙴𝙽𝙹𝙾𝚈 😍"""
    HELP_TXT = ""AUR YE HAIN {}
MADAD MERE 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂 SAMAJHNE K LIYE."""
    ABOUT_TXT = """✯MERA NAAM HAI : {}
...
- Source - https://github.com/Maverick19840806/Harsh 

<b>DEVS:</b>
- <a href=https://t.me/Maveriicckkk>Team Movies Masti Magic</a>"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and Maaveriicckkk24*7 will respond whenever a keyword is found the message
